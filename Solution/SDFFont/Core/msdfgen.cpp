...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double negDist = -SignedDistance::INFINITEDIS.distance;
                double posDist = SignedDistance::INFINITEDIS.distance;
                int winding = 0;
                ...
                double sd = SignedDistance::INFINITEDIS.distance;
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double psd = SignedDistance::INFINITEDIS.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    psd = posDist;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double d = fabs(SignedDistance::INFINITEDIS.distance);
                double negDist = -SignedDistance::INFINITEDIS.distance;
                double posDist = SignedDistance::INFINITEDIS.distance;
                int winding = 0;
                ...
                MultiDistance msd;
                msd.r = msd.g = msd.b = msd.med = SignedDistance::INFINITEDIS.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    msd.med = SignedDistance::INFINITEDIS.distance;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
